...
const typeMap: any = {
    "Event": o([
        ...
        { json: "finalDate", js: "finalDate", typ: "" },
        { json: "group", js: "group", typ: u(r("GroupClass"), 0) },
        { json: "calendar", js: "calendar", typ: a(r("Calendar")) },
        { json: "participation", js: "participation", typ: a(r("Participation")) },
    ], false),
    "Calendar": o([
        { json: "period", js: "period", typ: "" },
        { json: "votes", js: "votes", typ: 0 },
        { json: "freeForAll", js: "freeForAll", typ: true },
    ], false),
    "GroupClass": o([
        { json: "id", js: "id", typ: 0 },
    ], false),
    "Participation": o([
        { json: "user", js: "user", typ: u(r("UserClass"), "") },
